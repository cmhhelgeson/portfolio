  ...
  return (
    ...
    >
      <motion.path 
        ...
        animate={{rotateY: [0, 30, 60, 90], x: [-10, -8.5, -7, -6.8]}}
        initial={{x: "-10px"}}
        transition={{ease:"easeOut", duration: 0.3}}
      />
      <path d="M24.2 26.1h10v-9.8H23.4v.1v9.8" className={styles.st0}></path>
      <path d="M24.2 26.1h-10v9.8H34v-.1l-9.8-9.7z" className={styles.st1}></path>
      <path d="M14.3 35.8h9.9v9.9l-9.9-9.9z" className={styles.st2}></path>
      <path className={styles.st3} d="M47.8,35.8v-5.4h5.9v-2.5h-5.9v-3.6h6.4v-2.6h-9.3v14H47.8z"/>
      <path className={styles.st3} d="M61.6,25.6c-0.2-0.1-0.6-0.2-1.1-0.2c-1,0-1.8,0.5-2.3,1.2v-1h-2.8v10.2h2.8v-6.3c0.2-0.9,1-1.4,1.9-1.4
		    c0.5,0,1,0.1,1.4,0.3V25.6z" />
      <path className={styles.st3} d="M71,35.8v-6.5c0-2.4-1.6-3.9-4.3-3.9c-2.3,0-4,1.4-4.3,3.3h2.7c0.2-0.6,0.7-1,1.5-1c1.1,0,1.7,0.7,1.7,1.6V30
      ...
      <path className={styles.st3} d="M81,26.7c-0.6-0.8-1.5-1.3-2.7-1.3c-1.1,0-2.1,0.4-2.6,1.1v-0.8h-2.8v10.2h2.8v-6.6c0.2-0.9,0.9-1.3,1.6-1.3
      ...
      />
      <path className={styles.st3} d="M95.5,32.5c-0.2,0.9-0.9,1.3-1.9,1.3c-1.3,0-2.1-0.9-2.2-2.4h6.8v-0.9c0-3-1.6-5.1-4.6-5.1
      ...
      />
      <path className={styles.st3} d="M105.7,25.6c-0.2-0.1-0.6-0.2-1.1-0.2c-1,0-1.8,0.5-2.3,1.2v-1h-2.8v10.2h2.8v-6.3c0.2-0.9,1-1.4,1.9-1.4
		    c0.5,0,1,0.1,1.4,0.3V25.6z" 
      />
    </motion.svg>
  );
